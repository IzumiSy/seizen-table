---
title: Filtering
description: Add powerful filtering capabilities to your SeizenTable with type-aware operators and global search.
---
...
<DemoPreview demo="filter" height={350} client:only="react" />
...
<Aside type="tip">
  Combine filtering with [Column Control](/seizen-table/features/column-control) for a powerful data exploration experience.
</Aside>
